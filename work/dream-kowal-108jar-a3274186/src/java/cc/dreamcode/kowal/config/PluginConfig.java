...
public class PluginConfig extends OkaeriConfig
{
    ...
    public PluginConfig() {
        ...
        this.kowalLevels = new MapBuilder<Integer, Level>().put(1, new Level((Map<Material, Integer>)Collections.singletonMap((Object)Material.COAL, (Object)10), "&8» &aWegiel x10", "&8» &a35$", 35.0, "&b+0.5 odpornosc na obrazenia", 0.0015, 80)).put(2, new Level((Map<Material, Integer>)Collections.singletonMap((Object)Material.IRON_INGOT, (Object)8), "&8» &aSztabka zelaza x8", "&8» &a50$", 50.0, "&b+1.0 odpornosc na obrazenia", 0.002, 70)).put(3, new Level((Map<Material, Integer>)Collections.singletonMap((Object)Material.STRING, (Object)16), "&8» &aNi\u0107 x16", "&8» &a75$", 75.0, "&b+1.5 odpornosc na obrazenia", 0.0025, 60)).put(4, new Level((Map<Material, Integer>)Collections.singletonMap((Object)Material.EMERALD, (Object)2), "&8» &aEmeraldy x2", "&8» &a90$", 90.0, "&b+2.0 odpornosc na obrazenia", 0.003, 50)).put(5, new Level((Map<Material, Integer>)Collections.singletonMap((Object)Material.IRON_INGOT, (Object)16), "&8» &aSztabka zelaza x16", "&8» &a105$", 105.0, "&b+3.0 odpornosc na obrazenia", 0.0035, 40)).put(6, new Level((Map<Material, Integer>)Collections.singletonMap((Object)Material.EMERALD, (Object)6), "&8» &aEmeraldy x6", "&8» &a120$", 120.0, "&b+4.0 odpornosc na obrazenia", 0.004, 30)).put(7, new Level((Map<Material, Integer>)Collections.singletonMap((Object)Material.DIAMOND, (Object)6), "&8» &aDiamenty x6", "&8» &a145$", 145.0, "&b+5.0 odpornosc na obrazenia", 0.0045, 20)).build();
