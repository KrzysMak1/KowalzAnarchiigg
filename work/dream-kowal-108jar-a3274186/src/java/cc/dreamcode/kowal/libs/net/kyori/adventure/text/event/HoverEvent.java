...
public final class HoverEvent<V> implements Examinable, HoverEventSource<V>, StyleBuilderApplicable
{
    ...
    public static HoverEvent<ShowItem> showItem(@NotNull final Key item, final int count) {
        return showItem(item, count, (Map<Key, ? extends DataComponentValue>)Collections.emptyMap());
    }
    ...
    @NotNull
    public static HoverEvent<ShowItem> showItem(@NotNull final Keyed item, final int count, @NotNull final Map<Key, ? extends DataComponentValue> dataComponents) {
    ...
    private HoverEvent(@NotNull final Action<V> action, @NotNull final V value) {
        ...
        this.value = (V)Objects.requireNonNull((Object)value, "value");
    }
    ...
    public HoverEvent<V> asHoverEvent(@NotNull final UnaryOperator<V> op) {
        ...
        return new HoverEvent<V>(this.action, (V)op.apply((Object)this.value));
    }
    ...
    public static final class ShowItem implements Examinable
    {
        ...
        @NotNull
        public static ShowItem showItem(@NotNull final Key item, final int count) {
            return showItem(item, count, (Map<Key, ? extends DataComponentValue>)Collections.emptyMap());
        }
        ...
        @NotNull
        public static ShowItem showItem(@NotNull final Keyed item, final int count) {
            return showItem(item, count, (Map<Key, ? extends DataComponentValue>)Collections.emptyMap());
        }
        ...
        @Deprecated
        @NotNull
        public static ShowItem showItem(@NotNull final Key item, final int count, @Nullable final BinaryTagHolder nbt) {
            return new ShowItem((Key)Objects.requireNonNull((Object)item, "item"), count, nbt, (Map<Key, ? extends DataComponentValue>)Collections.emptyMap());
        }
        ...
        @Deprecated
        @NotNull
        public static ShowItem showItem(@NotNull final Keyed item, final int count, @Nullable final BinaryTagHolder nbt) {
            return new ShowItem(((Keyed)Objects.requireNonNull((Object)item, "item")).key(), count, nbt, (Map<Key, ? extends DataComponentValue>)Collections.emptyMap());
        }
        ...
        @NotNull
        public static ShowItem showItem(@NotNull final Keyed item, final int count, @NotNull final Map<Key, ? extends DataComponentValue> dataComponents) {
            return new ShowItem(((Keyed)Objects.requireNonNull((Object)item, "item")).key(), count, null, dataComponents);
        }
        
        private ShowItem(@NotNull final Key item, final int count, @Nullable final BinaryTagHolder nbt, @NotNull final Map<Key, ? extends DataComponentValue> dataComponents) {
            this.item = item;
            this.count = count;
            this.nbt = nbt;
            this.dataComponents = (Map<Key, DataComponentValue>)Collections.unmodifiableMap((Map)new HashMap((Map)dataComponents));
        }
        ...
        public ShowItem item(@NotNull final Key item) {
            if (Objects.requireNonNull((Object)item, "item").equals(this.item)) {
                return this;
            }
        ...
        public ShowItem nbt(@Nullable final BinaryTagHolder nbt) {
            if (Objects.equals((Object)nbt, (Object)this.nbt)) {
                return this;
            }
            return new ShowItem(this.item, this.count, nbt, (Map<Key, ? extends DataComponentValue>)Collections.emptyMap());
        }
        ...
        @NotNull
        public ShowItem dataComponents(@NotNull final Map<Key, DataComponentValue> holder) {
            if (Objects.equals((Object)this.dataComponents, (Object)holder)) {
                return this;
            }
            return new ShowItem(this.item, this.count, null, (Map<Key, ? extends DataComponentValue>)(holder.isEmpty() ? Collections.emptyMap() : Collections.unmodifiableMap((Map)new HashMap((Map)holder))));
        }
        ...
        public <V extends DataComponentValue> Map<Key, V> dataComponentsAs(@NotNull final Class<V> targetType) {
            if (this.dataComponents.isEmpty()) {
                return (Map<Key, V>)Collections.emptyMap();
            }
            final Map<Key, V> results = (Map<Key, V>)new HashMap(this.dataComponents.size());
            for (final Map.Entry<Key, DataComponentValue> entry : this.dataComponents.entrySet()) {
                results.put((Object)entry.getKey(), (Object)DataComponentValueConverterRegistry.convert(targetType, (Key)entry.getKey(), (DataComponentValue)entry.getValue()));
            }
            return (Map<Key, V>)Collections.unmodifiableMap((Map)results);
        }
        ...
        public boolean equals(@Nullable final Object other) {
            ...
            return this.item.equals(that.item) && this.count == that.count && Objects.equals((Object)this.nbt, (Object)that.nbt) && Objects.equals((Object)this.dataComponents, (Object)that.dataComponents);
        }
        ...
        public int hashCode() {
            ...
            result = 31 * result + Objects.hashCode((Object)this.nbt);
            result = 31 * result + Objects.hashCode((Object)this.dataComponents);
            return result;
        }
        ...
        @Override
        public Stream<? extends ExaminableProperty> examinableProperties() {
            return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("item", this.item), ExaminableProperty.of("count", this.count), ExaminableProperty.of("nbt", this.nbt), ExaminableProperty.of("dataComponents", this.dataComponents) });
        }
    ...
    public static final class ShowEntity implements Examinable
    {
        ...
        @NotNull
        public static ShowEntity showEntity(@NotNull final Key type, @NotNull final UUID id) {
            return showEntity(type, id, null);
        }
        ...
        @NotNull
        public static ShowEntity showEntity(@NotNull final Keyed type, @NotNull final UUID id) {
            return showEntity(type, id, null);
        }
        ...
        @NotNull
        public static ShowEntity showEntity(@NotNull final Key type, @NotNull final UUID id, @Nullable final Component name) {
            return new ShowEntity((Key)Objects.requireNonNull((Object)type, "type"), (UUID)Objects.requireNonNull((Object)id, "id"), name);
        }
        ...
        @NotNull
        public static ShowEntity showEntity(@NotNull final Keyed type, @NotNull final UUID id, @Nullable final Component name) {
            return new ShowEntity(((Keyed)Objects.requireNonNull((Object)type, "type")).key(), (UUID)Objects.requireNonNull((Object)id, "id"), name);
        }
        ...
        public ShowEntity type(@NotNull final Key type) {
            if (Objects.requireNonNull((Object)type, "type").equals(this.type)) {
                return this;
            }
        ...
        public ShowEntity type(@NotNull final Keyed type) {
            return this.type(((Keyed)Objects.requireNonNull((Object)type, "type")).key());
        }
        ...
        public ShowEntity id(@NotNull final UUID id) {
            if (((UUID)Objects.requireNonNull((Object)id)).equals((Object)this.id)) {
                return this;
            }
        ...
        public boolean equals(@Nullable final Object other) {
            ...
            return this.type.equals(that.type) && this.id.equals((Object)that.id) && Objects.equals((Object)this.name, (Object)that.name);
        }
        ...
        public int hashCode() {
            ...
            result = 31 * result + Objects.hashCode((Object)this.name);
            return result;
        }
        ...
        @Override
        public Stream<? extends ExaminableProperty> examinableProperties() {
            return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("type", this.type), ExaminableProperty.of("id", this.id), ExaminableProperty.of("name", this.name) });
        }
    ...
    public static final class Action<V>
    {
        ...
        @Deprecated
        public static final Action<String> SHOW_ACHIEVEMENT;
        ...
        static {
            ...
            SHOW_ACHIEVEMENT = new Action<String>("show_achievement", String.class, true, new Renderer<String>() {
                @NotNull
                @Override
            ...
            NAMES = Index.create((java.util.function.Function<? super Action, ? extends String>)(constant -> constant.name), (Action[])new Action[] { Action.SHOW_TEXT, Action.SHOW_ITEM, Action.SHOW_ENTITY, Action.SHOW_ACHIEVEMENT });
        }
