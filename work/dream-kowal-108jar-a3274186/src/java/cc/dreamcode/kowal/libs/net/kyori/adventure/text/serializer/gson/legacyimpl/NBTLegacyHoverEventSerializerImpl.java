...
import cc.dreamcode.kowal.libs.net.kyori.adventure.nbt.TagStringIO;
...
final class NBTLegacyHoverEventSerializerImpl implements LegacyHoverEventSerializer
{
    ...
    static {
        ...
        Objects.requireNonNull((Object)snbt_IO);
        ...
        Objects.requireNonNull((Object)snbt_IO2);
        SNBT_CODEC = Codec.codec((Codec.Decoder<CompoundBinaryTag, String, IOException>)decoder, (Codec.Encoder<CompoundBinaryTag, String, IOException>)snbt_IO2::asString);
    }
}
