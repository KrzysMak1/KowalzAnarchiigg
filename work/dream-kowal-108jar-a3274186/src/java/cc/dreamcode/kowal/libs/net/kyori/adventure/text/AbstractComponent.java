...
public abstract class AbstractComponent implements Component
{
    ...
    protected AbstractComponent(@NotNull final List<? extends ComponentLike> children, @NotNull final Style style) {
        this.children = ComponentLike.asComponents(children, (Predicate<? super Component>)AbstractComponent.IS_NOT_EMPTY);
        this.style = style;
    }
    ...
    public boolean equals(@Nullable final Object other) {
        ...
        return Objects.equals((Object)this.children, (Object)that.children) && Objects.equals((Object)this.style, (Object)that.style);
    }
    ...
    private String debuggerString() {
        final Stream<? extends ExaminableProperty> examinablePropertiesWithoutChildren = (Stream<? extends ExaminableProperty>)this.examinableProperties().filter(property -> !property.name().equals((Object)"children"));
