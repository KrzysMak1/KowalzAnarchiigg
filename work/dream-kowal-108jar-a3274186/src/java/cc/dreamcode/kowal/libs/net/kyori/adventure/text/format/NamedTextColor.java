...
public final class NamedTextColor implements TextColor
{
    ...
    public static NamedTextColor nearestTo(@NotNull final TextColor any) {
        ...
        return TextColor.nearestColorTo(NamedTextColor.VALUES, any);
    }
    ...
    public Stream<? extends ExaminableProperty> examinableProperties() {
        return (Stream<? extends ExaminableProperty>)Stream.concat(Stream.of((Object)ExaminableProperty.of("name", this.name)), (Stream)super.examinableProperties());
    }
