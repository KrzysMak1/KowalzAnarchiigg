...
public interface ForwardingAudience extends Audience
{
    ...
    default Audience filterAudience(@NotNull final Predicate<? super Audience> filter) {
        ...
        for (final Audience audience : this.audiences()) {
            if (filter.test((Object)audience)) {
                ...
                if (audiences == null) {
                    audiences = (List<Audience>)new ArrayList();
                }
                audiences.add((Object)filtered);
            }
        }
        return (audiences != null) ? Audience.audience((Iterable<? extends Audience>)audiences) : Audience.empty();
    }
    ...
    public interface Single extends ForwardingAudience
    {
        ...
        default Iterable<? extends Audience> audiences() {
            return (Iterable<? extends Audience>)Collections.singleton((Object)this.audience());
        }
        ...
        default Audience filterAudience(@NotNull final Predicate<? super Audience> filter) {
            ...
            return filter.test((Object)audience) ? this : Audience.empty();
        }
