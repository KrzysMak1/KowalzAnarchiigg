...
public final class BinaryTagIO
{
    ...
    public interface Reader
    {
        ...
        @NotNull
        CompoundBinaryTag readNameless(@NotNull final Path path, @NotNull final Compression compression) throws IOException;
        ...
        @NotNull
        CompoundBinaryTag readNameless(@NotNull final InputStream input, @NotNull final Compression compression) throws IOException;
    ...
    public interface Writer
    {
        ...
        void writeNameless(@NotNull final CompoundBinaryTag tag, @NotNull final Path path, @NotNull final Compression compression) throws IOException;
        ...
        void writeNameless(@NotNull final CompoundBinaryTag tag, @NotNull final OutputStream output, @NotNull final Compression compression) throws IOException;
        ...
        static {
            ...
            GZIP = new Compression() {
                ...
                InputStream decompress(@NotNull final InputStream is) throws IOException {
                    return (InputStream)new GZIPInputStream(is);
                }
                
                @NotNull
                @Override
                OutputStream compress(@NotNull final OutputStream os) throws IOException {
                    return (OutputStream)new GZIPOutputStream(os);
                }
            ...
            ZLIB = new Compression() {
                ...
                @Override
                InputStream decompress(@NotNull final InputStream is) {
                    return (InputStream)new InflaterInputStream(is);
                }
                
                @NotNull
                @Override
                OutputStream compress(@NotNull final OutputStream os) {
                    return (OutputStream)new DeflaterOutputStream(os);
                }
