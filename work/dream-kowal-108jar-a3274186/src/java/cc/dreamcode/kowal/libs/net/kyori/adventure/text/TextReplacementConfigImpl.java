...
final class TextReplacementConfigImpl implements TextReplacementConfig
{
    ...
    public Stream<? extends ExaminableProperty> examinableProperties() {
        return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("matchPattern", this.matchPattern), ExaminableProperty.of("replacement", this.replacement), ExaminableProperty.of("continuer", this.continuer) });
    }
    ...
    static final class Builder implements TextReplacementConfig.Builder
    {
        ...
        public Builder match(@NotNull final Pattern pattern) {
            this.matchPattern = (Pattern)Objects.requireNonNull((Object)pattern, "pattern");
            return this;
        }
        ...
        public Builder condition(final Condition condition) {
            this.continuer = (Condition)Objects.requireNonNull((Object)condition, "continuation");
            return this;
        }
        ...
        public Builder replacement(@NotNull final BiFunction<MatchResult, TextComponent.Builder, ComponentLike> replacement) {
            this.replacement = (BiFunction<MatchResult, TextComponent.Builder, ComponentLike>)Objects.requireNonNull((Object)replacement, "replacement");
            return this;
        }
