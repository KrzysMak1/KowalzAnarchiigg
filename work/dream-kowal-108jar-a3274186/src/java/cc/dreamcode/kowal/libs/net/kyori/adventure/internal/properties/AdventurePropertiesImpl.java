...
final class AdventurePropertiesImpl
{
    ...
    static String systemPropertyName(final String name) {
        return String.join((CharSequence)".", new CharSequence[] { (CharSequence)"net", (CharSequence)"kyori", (CharSequence)"adventure", (CharSequence)name });
    }
    ...
    static {
        ...
        final Path path = (Path)Optional.ofNullable((Object)System.getProperty(systemPropertyName("config"))).map(x$0 -> Paths.get(x$0, new String[0])).orElseGet(() -> Paths.get("config", new String[] { "adventure.properties" }));
    ...
    private static final class PropertyImpl<T> implements AdventureProperties.Property<T>
    {
        ...
        public T value() {
            if (!this.valueCalculated) {
                ...
                if (value != null) {
                    this.value = (T)this.parser.apply((Object)value);
                }
                if (this.value == null) {
