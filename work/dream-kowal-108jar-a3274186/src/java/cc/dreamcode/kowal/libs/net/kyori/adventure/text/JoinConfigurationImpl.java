...
final class JoinConfigurationImpl implements JoinConfiguration
{
    ...
    public Stream<? extends ExaminableProperty> examinableProperties() {
        return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("prefix", this.prefix), ExaminableProperty.of("suffix", this.suffix), ExaminableProperty.of("separator", this.separator), ExaminableProperty.of("lastSeparator", this.lastSeparator), ExaminableProperty.of("lastSeparatorIfSerial", this.lastSeparatorIfSerial), ExaminableProperty.of("convertor", this.convertor), ExaminableProperty.of("predicate", this.predicate), ExaminableProperty.of("rootStyle", this.rootStyle) });
    }
    ...
    static Component join(@NotNull final JoinConfiguration config, @NotNull final Iterable<? extends ComponentLike> components) {
        Objects.requireNonNull((Object)config, "config");
        Objects.requireNonNull((Object)components, "components");
        final Iterator<? extends ComponentLike> it = (Iterator<? extends ComponentLike>)components.iterator();
        if (!it.hasNext()) {
            return singleElementJoin(config, null);
        }
        ComponentLike component = (ComponentLike)Objects.requireNonNull((Object)it.next(), "Null elements in \"components\" are not allowed");
        ...
        while (component != null) {
            if (!predicate.test((Object)component)) {
                if (!it.hasNext()) {
                    break;
                }
                ...
                builder.append((Component)Objects.requireNonNull((Object)convertor.apply((Object)component), "Null output from \"convertor\" is not allowed"));
                ++componentsSeen;
                if (!it.hasNext()) {
                    component = null;
                }
                else {
                    component = (ComponentLike)Objects.requireNonNull((Object)it.next(), "Null elements in \"components\" are not allowed");
                    if (it.hasNext()) {
                        if (!hasSeparator) {
                            continue;
                        }
    ...
    static Component singleElementJoin(@NotNull final JoinConfiguration config, @Nullable final ComponentLike component) {
        ...
        if (prefix == null && suffix == null) {
            Component result;
            if (component == null || !predicate.test((Object)component)) {
                result = Component.empty();
            }
            else {
                result = (Component)convertor.apply((Object)component);
            }
        ...
        if (component != null && predicate.test((Object)component)) {
            builder.append((Component)convertor.apply((Object)component));
        }
        if (suffix != null) {
            builder.append(suffix);
        }
    ...
    static {
        ...
        STANDARD_SPACES = JoinConfiguration.separator(Component.space());
    ...
    static final class BuilderImpl implements Builder
    {
        ...
        public Builder convertor(@NotNull final Function<ComponentLike, Component> convertor) {
            this.convertor = (Function<ComponentLike, Component>)Objects.requireNonNull((Object)convertor, "convertor");
            return this;
        }
        ...
        public Builder predicate(@NotNull final Predicate<ComponentLike> predicate) {
            this.predicate = (Predicate<ComponentLike>)Objects.requireNonNull((Object)predicate, "predicate");
            return this;
        }
        ...
        public Builder parentStyle(@NotNull final Style parentStyle) {
            this.rootStyle = (Style)Objects.requireNonNull((Object)parentStyle, "rootStyle");
            return this;
        }
