...
public interface BossBar extends Examinable
{
    ...
    @NotNull
    default BossBar addViewer(@NotNull final Audience viewer) {
        viewer.showBossBar(this);
        return this;
    }
    
    @NotNull
    default BossBar removeViewer(@NotNull final Audience viewer) {
    ...
    public enum Color
    {
        ...
        static {
            NAMES = Index.create(Color.class, (java.util.function.Function<? super Color, ? extends String>)(color -> color.name));
        }
    }
    ...
    public enum Flag
    {
        ...
        static {
            NAMES = Index.create(Flag.class, (java.util.function.Function<? super Flag, ? extends String>)(flag -> flag.name));
        }
    }
    ...
    public enum Overlay
    {
        ...
        static {
            NAMES = Index.create(Overlay.class, (java.util.function.Function<? super Overlay, ? extends String>)(overlay -> overlay.name));
        }
    }
}
