...
import cc.dreamcode.kowal.libs.net.kyori.adventure.util.ForwardingIterator;
...
import cc.dreamcode.kowal.libs.net.kyori.adventure.text.format.StyleGetter;
...
public interface Component extends ComponentBuilderApplicable, ComponentLike, Examinable, HoverEventSource<Component>, StyleGetter, StyleSetter<Component>
{
    ...
    public static final Predicate<? super Component> IS_NOT_EMPTY = component -> component != empty();
    ...
    default TextComponent join(@NotNull final ComponentLike separator, @NotNull final ComponentLike... components) {
        return join(separator, (Iterable<? extends ComponentLike>)Arrays.asList((Object[])components));
    }
    ...
    @Contract(pure = true)
    @NotNull
    default Component join(final JoinConfiguration.Builder configBuilder, @NotNull final ComponentLike... components) {
        return join(configBuilder, (Iterable<? extends ComponentLike>)Arrays.asList((Object[])components));
    }
    
    @Contract(pure = true)
    @NotNull
    default Component join(final JoinConfiguration.Builder configBuilder, @NotNull final Iterable<? extends ComponentLike> components) {
    ...
    default Component join(@NotNull final JoinConfiguration config, @NotNull final ComponentLike... components) {
        return join(config, (Iterable<? extends ComponentLike>)Arrays.asList((Object[])components));
    }
    ...
    default Collector<Component, ? extends ComponentBuilder<?, ?>, Component> toComponent(@NotNull final Component separator) {
        return (Collector<Component, ? extends ComponentBuilder<?, ?>, Component>)Collector.of(Component::text, (builder, add) -> {
            ...
            final TextComponent.Builder ret = ((ComponentBuilder<C, TextComponent.Builder>)text()).append((Iterable<? extends ComponentLike>)aChildren);
            if (!aChildren.isEmpty()) {
                ret.append(separator);
            }
            ret.append((Iterable<? extends ComponentLike>)b.children());
            return ret;
    ...
    default BlockNBTComponent blockNBT(@NotNull final String nbtPath, final boolean interpret, @Nullable final ComponentLike separator, final BlockNBTComponent.Pos pos) {
        return BlockNBTComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), Style.empty(), nbtPath, interpret, separator, pos);
    }
    ...
    default KeybindComponent keybind(final KeybindComponent.KeybindLike keybind) {
        return keybind(((KeybindComponent.KeybindLike)Objects.requireNonNull((Object)keybind, "keybind")).asKeybind(), Style.empty());
    }
    
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default KeybindComponent keybind(@NotNull final String keybind, @NotNull final Style style) {
        return KeybindComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), keybind);
    }
    
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default KeybindComponent keybind(final KeybindComponent.KeybindLike keybind, @NotNull final Style style) {
        return KeybindComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), ((KeybindComponent.KeybindLike)Objects.requireNonNull((Object)keybind, "keybind")).asKeybind());
    }
    ...
    default KeybindComponent keybind(final KeybindComponent.KeybindLike keybind, @Nullable final TextColor color) {
        return keybind(((KeybindComponent.KeybindLike)Objects.requireNonNull((Object)keybind, "keybind")).asKeybind(), Style.style(color));
    }
    ...
    default KeybindComponent keybind(final KeybindComponent.KeybindLike keybind, @Nullable final TextColor color, final TextDecoration... decorations) {
        return keybind(((KeybindComponent.KeybindLike)Objects.requireNonNull((Object)keybind, "keybind")).asKeybind(), Style.style(color, decorations));
    }
    ...
    default ScoreComponent score(@NotNull final String name, @NotNull final String objective, @Nullable final String value) {
        return ScoreComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), Style.empty(), name, objective, value);
    }
    ...
    default SelectorComponent selector(@NotNull final String pattern, @Nullable final ComponentLike separator) {
        return SelectorComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), Style.empty(), pattern, separator);
    }
    ...
    default StorageNBTComponent storageNBT(@NotNull final String nbtPath, final boolean interpret, @Nullable final ComponentLike separator, @NotNull final Key storage) {
        return StorageNBTComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), Style.empty(), nbtPath, interpret, separator, storage);
    }
    ...
    @NotNull
    default TextComponent textOfChildren(@NotNull final ComponentLike... components) {
        if (components.length == 0) {
            return empty();
        }
        return TextComponentImpl.create((List<? extends ComponentLike>)Arrays.asList((Object[])components), Style.empty(), "");
    }
    ...
    default TextComponent text(@NotNull final String content, @NotNull final Style style) {
        return TextComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), content);
    }
    ...
    default TranslatableComponent translatable(@NotNull final Translatable translatable) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), Style.empty());
    }
    
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback) {
        return translatable(key, fallback, Style.empty());
    }
    
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, Style.empty());
    }
    
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @NotNull final Style style) {
        return TranslatableComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), key, null, (List<? extends ComponentLike>)Collections.emptyList());
    }
    
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @NotNull final Style style) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), style);
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final Style style) {
        return TranslatableComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), key, fallback, (List<? extends ComponentLike>)Collections.emptyList());
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, style);
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final StyleBuilderApplicable... style) {
        return translatable((String)Objects.requireNonNull((Object)key, "key"), fallback, Style.style(style));
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Iterable<StyleBuilderApplicable> style) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, Style.style(style));
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final ComponentLike... args) {
        return translatable(key, fallback, Style.empty(), args);
    }
    
    @Contract(value = "_, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final ComponentLike... args) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, args);
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final Style style, @NotNull final ComponentLike... args) {
        return TranslatableComponentImpl.create((List<Component>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), key, fallback, (ComponentLike[])Objects.requireNonNull((Object)args, "args"));
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style, @NotNull final ComponentLike... args) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, style, args);
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args) {
        return TranslatableComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), style, key, fallback, (List<? extends ComponentLike>)Objects.requireNonNull((Object)args, "args"));
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, style, args);
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final Iterable<StyleBuilderApplicable> style) {
        return TranslatableComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), Style.style(style), key, fallback, (List<? extends ComponentLike>)Objects.requireNonNull((Object)args, "args"));
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final Iterable<StyleBuilderApplicable> style) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, args, style);
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final StyleBuilderApplicable... style) {
        return TranslatableComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), Style.style(style), key, fallback, (List<? extends ComponentLike>)Objects.requireNonNull((Object)args, "args"));
    }
    
    @Contract(value = "_, _, _, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final String fallback, @NotNull final List<? extends ComponentLike> args, @NotNull final StyleBuilderApplicable... style) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), fallback, args, style);
    }
    ...
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final TextColor color) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), color);
    }
    ...
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final TextColor color, final TextDecoration... decorations) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), color, decorations);
    }
    ...
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @NotNull final ComponentLike... args) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), args);
    }
    ...
    default TranslatableComponent translatable(@NotNull final String key, @NotNull final Style style, @NotNull final ComponentLike... args) {
        return TranslatableComponentImpl.create((List<Component>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), key, null, (ComponentLike[])Objects.requireNonNull((Object)args, "args"));
    }
    ...
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @NotNull final Style style, @NotNull final ComponentLike... args) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), style, args);
    }
    ...
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final TextColor color, @NotNull final ComponentLike... args) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), color, args);
    }
    ...
    default TranslatableComponent translatable(@NotNull final Translatable translatable, @Nullable final TextColor color, @NotNull final Set<TextDecoration> decorations, @NotNull final ComponentLike... args) {
        return translatable(((Translatable)Objects.requireNonNull((Object)translatable, "translatable")).translationKey(), color, decorations, args);
    }
    
    @Contract(value = "_, _ -> new", pure = true)
    @NotNull
    default TranslatableComponent translatable(@NotNull final String key, @NotNull final List<? extends ComponentLike> args) {
        return TranslatableComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), Style.empty(), key, null, (List<? extends ComponentLike>)Objects.requireNonNull((Object)args, "args"));
    }
    ...
    default TranslatableComponent translatable(@NotNull final String key, @NotNull final Style style, @NotNull final List<? extends ComponentLike> args) {
        return TranslatableComponentImpl.create((List<? extends ComponentLike>)Collections.emptyList(), (Style)Objects.requireNonNull((Object)style, "style"), key, null, (List<? extends ComponentLike>)Objects.requireNonNull((Object)args, "args"));
    }
    ...
    default boolean contains(@NotNull final Component that, @NotNull final BiPredicate<? super Component, ? super Component> equals) {
        if (equals.test((Object)this, (Object)that)) {
            return true;
        }
        ...
        if (hoverEvent != null) {
            ...
            if (component != null) {
                if (equals.test((Object)that, (Object)component)) {
                    return true;
                }
    ...
    default void detectCycle(@NotNull final Component that) {
        if (that.contains(this)) {
            throw new IllegalStateException("Component cycle detected between " + (Object)this + " and " + (Object)that);
        }
    }
    ...
    default Component append(@NotNull final ComponentLike like) {
        Objects.requireNonNull((Object)like, "like");
    ...
    default Component replaceText(@NotNull final Consumer<TextReplacementConfig.Builder> configurer) {
        Objects.requireNonNull((Object)configurer, "configurer");
    ...
    default Component replaceText(@NotNull final TextReplacementConfig config) {
        Objects.requireNonNull((Object)config, "replacement");
    ...
    default Iterable<Component> iterable(@NotNull final ComponentIteratorType type, @NotNull final ComponentIteratorFlag... flags) {
        return this.iterable(type, (Set<ComponentIteratorFlag>)((flags == null) ? Collections.emptySet() : MonkeyBars.enumSet(ComponentIteratorFlag.class, flags)));
    }
    ...
    default Iterable<Component> iterable(@NotNull final ComponentIteratorType type, @NotNull final Set<ComponentIteratorFlag> flags) {
        Objects.requireNonNull((Object)type, "type");
        Objects.requireNonNull((Object)flags, "flags");
        return (Iterable<Component>)new ForwardingIterator((java.util.function.Supplier<java.util.Iterator<Object>>)(() -> this.iterator(type, flags)), (java.util.function.Supplier<java.util.Spliterator<Object>>)(() -> this.spliterator(type, flags)));
    }
    
    @NotNull
    default Iterator<Component> iterator(@NotNull final ComponentIteratorType type, @NotNull final ComponentIteratorFlag... flags) {
        return this.iterator(type, (Set<ComponentIteratorFlag>)((flags == null) ? Collections.emptySet() : MonkeyBars.enumSet(ComponentIteratorFlag.class, flags)));
    }
    ...
    default Iterator<Component> iterator(@NotNull final ComponentIteratorType type, @NotNull final Set<ComponentIteratorFlag> flags) {
        return (Iterator<Component>)new ComponentIterator(this, (ComponentIteratorType)Objects.requireNonNull((Object)type, "type"), (Set<ComponentIteratorFlag>)Objects.requireNonNull((Object)flags, "flags"));
    }
    ...
    default Spliterator<Component> spliterator(@NotNull final ComponentIteratorType type, @NotNull final ComponentIteratorFlag... flags) {
        return this.spliterator(type, (Set<ComponentIteratorFlag>)((flags == null) ? Collections.emptySet() : MonkeyBars.enumSet(ComponentIteratorFlag.class, flags)));
    }
    ...
    default Spliterator<Component> spliterator(@NotNull final ComponentIteratorType type, @NotNull final Set<ComponentIteratorFlag> flags) {
        return (Spliterator<Component>)Spliterators.spliteratorUnknownSize((Iterator)this.iterator(type, flags), 1296);
    }
    ...
    default Component replaceText(@NotNull final String search, @Nullable final ComponentLike replacement) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.matchLiteral(search).replacement(replacement)));
    }
    ...
    default Component replaceText(@NotNull final Pattern pattern, @NotNull final Function<TextComponent.Builder, ComponentLike> replacement) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.match(pattern).replacement(replacement)));
    }
    ...
    default Component replaceFirstText(@NotNull final String search, @Nullable final ComponentLike replacement) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.matchLiteral(search).once().replacement(replacement)));
    }
    ...
    default Component replaceFirstText(@NotNull final Pattern pattern, @NotNull final Function<TextComponent.Builder, ComponentLike> replacement) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.match(pattern).once().replacement(replacement)));
    }
    ...
    default Component replaceText(@NotNull final String search, @Nullable final ComponentLike replacement, final int numberOfReplacements) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.matchLiteral(search).times(numberOfReplacements).replacement(replacement)));
    }
    ...
    default Component replaceText(@NotNull final Pattern pattern, @NotNull final Function<TextComponent.Builder, ComponentLike> replacement, final int numberOfReplacements) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.match(pattern).times(numberOfReplacements).replacement(replacement)));
    }
    ...
    default Component replaceText(@NotNull final String search, @Nullable final ComponentLike replacement, @NotNull final IntFunction2<PatternReplacementResult> fn) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.matchLiteral(search).replacement(replacement).condition(fn)));
    }
    ...
    default Component replaceText(@NotNull final Pattern pattern, @NotNull final Function<TextComponent.Builder, ComponentLike> replacement, @NotNull final IntFunction2<PatternReplacementResult> fn) {
        return this.replaceText((Consumer<TextReplacementConfig.Builder>)(b -> b.match(pattern).replacement(replacement).condition(fn)));
    }
    ...
    default HoverEvent<Component> asHoverEvent(@NotNull final UnaryOperator<Component> op) {
        return HoverEvent.showText((Component)op.apply((Object)this));
    }
    
    @NotNull
    default Stream<? extends ExaminableProperty> examinableProperties() {
        return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("style", this.style()), ExaminableProperty.of("children", this.children()) });
    }
}
