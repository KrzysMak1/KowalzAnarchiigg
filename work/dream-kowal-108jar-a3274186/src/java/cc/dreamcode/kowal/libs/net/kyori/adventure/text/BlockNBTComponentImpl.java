...
import cc.dreamcode.kowal.libs.net.kyori.adventure.util.ShadyPines;
...
final class BlockNBTComponentImpl extends NBTComponentImpl<BlockNBTComponent, BlockNBTComponent.Builder> implements BlockNBTComponent
{
    ...
    static BlockNBTComponent create(@NotNull final List<? extends ComponentLike> children, @NotNull final Style style, final String nbtPath, final boolean interpret, @Nullable final ComponentLike separator, @NotNull final Pos pos) {
        return new BlockNBTComponentImpl(ComponentLike.asComponents(children, (Predicate<? super Component>)BlockNBTComponentImpl.IS_NOT_EMPTY), (Style)Objects.requireNonNull((Object)style, "style"), (String)Objects.requireNonNull((Object)nbtPath, "nbtPath"), interpret, ComponentLike.unbox(separator), (Pos)Objects.requireNonNull((Object)pos, "pos"));
    }
    
    BlockNBTComponentImpl(@NotNull final List<Component> children, @NotNull final Style style, final String nbtPath, final boolean interpret, @Nullable final Component separator, @NotNull final Pos pos) {
    ...
    public boolean equals(@Nullable final Object other) {
        ...
        return Objects.equals((Object)this.pos, (Object)that.pos());
    }
    ...
    static final class BuilderImpl extends AbstractNBTComponentBuilder<BlockNBTComponent, BlockNBTComponent.Builder> implements BlockNBTComponent.Builder
    {
        ...
        public BlockNBTComponent.Builder pos(@NotNull final Pos pos) {
            this.pos = (Pos)Objects.requireNonNull((Object)pos, "pos");
            return this;
        }
    ...
    static final class LocalPosImpl implements LocalPos
    {
        ...
        public Stream<? extends ExaminableProperty> examinableProperties() {
            return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("left", this.left), ExaminableProperty.of("up", this.up), ExaminableProperty.of("forwards", this.forwards) });
        }
        ...
        @Override
        public String toString() {
            return String.format("^%f ^%f ^%f", new Object[] { this.left, this.up, this.forwards });
        }
    ...
    static final class WorldPosImpl implements WorldPos
    {
        ...
        WorldPosImpl(final Coordinate x, final Coordinate y, final Coordinate z) {
            this.x = (Coordinate)Objects.requireNonNull((Object)x, "x");
            this.y = (Coordinate)Objects.requireNonNull((Object)y, "y");
            this.z = (Coordinate)Objects.requireNonNull((Object)z, "z");
        }
        ...
        @Override
        public Stream<? extends ExaminableProperty> examinableProperties() {
            return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("x", this.x), ExaminableProperty.of("y", this.y), ExaminableProperty.of("z", this.z) });
        }
        ...
        static final class CoordinateImpl implements Coordinate
        {
            ...
            CoordinateImpl(final int value, @NotNull final Type type) {
                this.value = value;
                this.type = (Type)Objects.requireNonNull((Object)type, "type");
            }
            ...
            @Override
            public Stream<? extends ExaminableProperty> examinableProperties() {
                return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("value", this.value), ExaminableProperty.of("type", this.type) });
            }
