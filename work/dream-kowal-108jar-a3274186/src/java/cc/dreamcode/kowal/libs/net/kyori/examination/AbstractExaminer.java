package cc.dreamcode.kowal.libs.net.kyori.examination;
...
public abstract class AbstractExaminer<R> implements Examiner<R>
{
    ...
    public R examine(@Nullable final Object value) {
        ...
        if (value instanceof Collection) {
            return this.collection((java.util.Collection<Object>)value);
        }
        if (value instanceof Map) {
            return this.map((java.util.Map<Object, Object>)value);
        }
        ...
        if (value instanceof Number) {
            ...
            if (value instanceof Stream) {
                return this.stream((java.util.stream.Stream<Object>)value);
            }
    ...
    private <E> R array(final E[] array) {
        return this.array(array, (Stream<R>)Arrays.stream((Object[])array).map(this::examine));
    }
    ...
    private <E> R collection(@NotNull final Collection<E> collection) {
        return this.collection(collection, (Stream<R>)collection.stream().map(this::examine));
    }
    ...
    public R examine(@NotNull final String name, @NotNull final Stream<? extends ExaminableProperty> properties) {
        return this.examinable(name, (Stream<Map.Entry<String, R>>)properties.map(property -> new AbstractMap.SimpleImmutableEntry((Object)property.name(), property.examine((Examiner<?>)this))));
    }
    ...
    private <K, V> R map(@NotNull final Map<K, V> map) {
        return this.map(map, (Stream<Map.Entry<R, R>>)map.entrySet().stream().map(entry -> new AbstractMap.SimpleImmutableEntry(this.examine(entry.getKey()), this.examine(entry.getValue()))));
    }
    ...
    public R examine(final boolean[] values) {
        ...
        return this.array(values.length, (IntFunction<R>)(index -> this.examine(values[index])));
    }
