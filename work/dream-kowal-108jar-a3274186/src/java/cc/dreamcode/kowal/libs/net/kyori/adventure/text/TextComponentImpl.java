...
import cc.dreamcode.kowal.libs.net.kyori.adventure.util.Nag;
...
final class TextComponentImpl extends AbstractComponent implements TextComponent
{
    ...
    static TextComponent create(@NotNull final List<? extends ComponentLike> children, @NotNull final Style style, @NotNull final String content) {
        final List<Component> filteredChildren = ComponentLike.asComponents(children, (Predicate<? super Component>)TextComponentImpl.IS_NOT_EMPTY);
        if (filteredChildren.isEmpty() && style.isEmpty() && content.isEmpty()) {
            return Component.empty();
        }
        return new TextComponentImpl(filteredChildren, (Style)Objects.requireNonNull((Object)style, "style"), (String)Objects.requireNonNull((Object)content, "content"));
    }
    
    @NotNull
    private static TextComponent createDirect(@NotNull final String content) {
        return new TextComponentImpl((List<Component>)Collections.emptyList(), Style.empty(), content);
    }
    ...
    public TextComponent content(@NotNull final String content) {
        if (Objects.equals((Object)this.content, (Object)content)) {
            return this;
        }
    ...
    public boolean equals(@Nullable final Object other) {
        ...
        return Objects.equals((Object)this.content, (Object)that.content);
    }
    ...
    static {
        WARN_WHEN_LEGACY_FORMATTING_DETECTED = Boolean.TRUE.equals((Object)AdventureProperties.TEXT_WARN_WHEN_LEGACY_FORMATTING_DETECTED.value());
        EMPTY = createDirect("");
    ...
    static final class BuilderImpl extends AbstractComponentBuilder<TextComponent, TextComponent.Builder> implements TextComponent.Builder
    {
        ...
        public TextComponent.Builder content(@NotNull final String content) {
            this.content = (String)Objects.requireNonNull((Object)content, "content");
            return this;
        }
