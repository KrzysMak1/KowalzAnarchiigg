...
final class BinaryTagHolderImpl implements BinaryTagHolder
{
    ...
    BinaryTagHolderImpl(final String string) {
        this.string = (String)Objects.requireNonNull((Object)string, "string");
    }
    ...
    public boolean equals(final Object that) {
        return that instanceof BinaryTagHolderImpl && this.string.equals((Object)((BinaryTagHolderImpl)that).string);
    }
