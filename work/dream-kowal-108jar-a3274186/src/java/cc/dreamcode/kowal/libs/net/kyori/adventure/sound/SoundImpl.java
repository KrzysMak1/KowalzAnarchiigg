...
abstract class SoundImpl implements Sound
{
    ...
    public boolean equals(@Nullable final Object other) {
        ...
        return this.name().equals(that.name()) && this.source == that.source && ShadyPines.equals(this.volume, that.volume) && ShadyPines.equals(this.pitch, that.pitch) && this.seed.equals((Object)that.seed);
    }
    ...
    public Stream<? extends ExaminableProperty> examinableProperties() {
        return (Stream<? extends ExaminableProperty>)Stream.of((Object[])new ExaminableProperty[] { ExaminableProperty.of("name", this.name()), ExaminableProperty.of("source", this.source), ExaminableProperty.of("volume", this.volume), ExaminableProperty.of("pitch", this.pitch), ExaminableProperty.of("seed", this.seed) });
    }
    ...
    static final class BuilderImpl implements Builder
    {
        ...
        BuilderImpl(@NotNull final Sound existing) {
            ...
            if (existing instanceof Eager) {
                ...
                if (!(existing instanceof Lazy)) {
                    throw new IllegalArgumentException("Unknown sound type " + (Object)existing + ", must be Eager or Lazy");
                }
        ...
        public Builder type(@NotNull final Key type) {
            this.eagerType = (Key)Objects.requireNonNull((Object)type, "type");
            this.lazyType = null;
            return this;
        }
        ...
        public Builder type(@NotNull final Type type) {
            this.eagerType = (Key)Objects.requireNonNull((Object)((Type)Objects.requireNonNull((Object)type, "type")).key(), "type.key()");
            this.lazyType = null;
            return this;
        }
        ...
        public Builder type(@NotNull final Supplier<? extends Type> typeSupplier) {
            this.lazyType = (Supplier<? extends Type>)Objects.requireNonNull((Object)typeSupplier, "typeSupplier");
            this.eagerType = null;
            return this;
        }
        ...
        public Builder source(@NotNull final Source source) {
            this.source = (Source)Objects.requireNonNull((Object)source, "source");
            return this;
        }
        ...
        public Builder seed(@NotNull final OptionalLong seed) {
            this.seed = (OptionalLong)Objects.requireNonNull((Object)seed, "seed");
            return this;
        }
